...
class MyPageComponent extends StatefulWidget {
  MyPageComponent(@required this.datas, {Key key, Function this.callback})
...
class MyPageComponentState extends State<MyPageComponent> {
  ...
  Widget _pageView(constraints, callback) => new NotificationListener(
